...
function crearSetsEntrenamiento() {
  /*
    entradas: [val, val, ..., val] -> numero en x hacia la derecha, cantidad de entradas hacia abajo
    salidas: [val, val, ..., val] -> numero en x hacia la derecha, cantidad de entradas hacia abajo
  */
